...
export const companionHunterCards: CardDefinition[] = [
  ...
  card({ id: "companion_hunter_face_the_tolvir", name: "直面托维尔", class: "hunter", type: "spell", rarity: "rare", cost: 3, text: "再次使用你在本局对战中使用过的每一张法力值消耗为（1）的牌（尽可能以敌人为目标）。", rules: ["hunter_face_the_tolvir"] }),
  ...
  card({ id: "companion_token_leokk", name: "雷欧克", class: "hunter", type: "minion", rarity: "common", cost: 3, attack: 2, health: 4, races: ["BEAST"], text: "你的其他随从获得+1攻击力。", collectible: false }),
  ...
  card({ id: "companion_choice_misha", name: "召唤米莎", class: "hunter", type: "spell", rarity: "common", cost: 0, text: "召唤米莎。", rules: ["hunter_companion_misha"], collectible: false }),
  card({ id: "companion_choice_leokk", name: "召唤雷欧克", class: "hunter", type: "spell", rarity: "common", cost: 0, text: "召唤雷欧克。", rules: ["hunter_companion_leokk"], collectible: false }),
  card({ id: "companion_choice_huffer", name: "召唤霍弗", class: "hunter", type: "spell", rarity: "common", cost: 0, text: "召唤霍弗。", rules: ["hunter_companion_huffer"], collectible: false }),
...
export const companionHunterDeckCardIds = [
  "companion_hunter_mad_alchemist",
  ...
  ...Array(2).fill("companion_hunter_tracking"),
  ...Array(2).fill("companion_hunter_little_critter_caretaker"),
  ...Array(2).fill("companion_hunter_wound_prey"),
  ...Array(2).fill("companion_hunter_blazing_cinder"),
  ...Array(2).fill("companion_hunter_sands_of_time"),
...
export const companionHunterTemplate: DeckTemplate = {
  ...
  annoyance: 4,
  uniqueness: 5,
  coreCardsZh: ["动物伙伴", "塔雅·陆行", "驯服宠物", "迁徙的雷象", "自由漫步"],
  coreCardsEn: ["Animal Companion", "Taya Runetotem", "Tame Beast", "Migrating Elekk", "Free Roam"],
  winCondition: "用1费组件和动物伙伴建立场面，通过驯服宠物、迁徙的雷象和自由漫步把后续伙伴升级成更高费随机野兽，再用塔雅与兽群呼唤扩大场面压力。",
  whyIncluded: "按用户提供的伙伴猎链接和炉石卡牌数据接入，并为动物伙伴、伙伴升级、野兽池、游侠三姐妹和关键亡语/回合结束效果补上可执行规则。",
  recommendedUse: "在大厅直接选择这套30张伙伴猎开始对战。",
  sourceNote: "牌表由公开伙伴猎卡组代码解码并用 HearthstoneJSON 中文卡牌数据核对；营地详情页在当前环境只返回页面空壳。",
  sourceUrls: [
